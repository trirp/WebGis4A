...
var map = new ol.Map({
  ...
  new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_IDM_2021_SANITASI_AR/MapServer',
			}),
		name: 'World Label',
		LegenUrl:'',
		LegentType :'ESRI',
  ...
  new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_PERKANTORAN_PEMPROV/MapServer',
			}),
		name: 'World Label',
		LegenUrl:'',
		LegentType :'ESRI',
